  ...
  return (
    <div className="">
         ...
         "justify-end":"justify-start"}`}>
           <div className={`my-2 ${message.sender == currentUser ?"bg-green-800" : "bg-gray-800"} p-2 max-w-xs rounded`}>
            <div className="flex flex-row gap-2">
              <img className="h-10 w-10" src={"https://avatar.iran.liara.run/public/46"} alt="" />
      ...
      <div className="fixed bottom-4 w-full h-16">
        <div className="h-full pr-10 gap-4 flex items-center justify-between w-1/2 rounded-lg mx-auto dark:bg-gray-900">
        <input value={input}
         onChange={(e)=>{
        ...
        type="text"
         ...
         className="w-full dark:border-gray-600 dark:bg-gray-800 px-5 py-2 rounded-lg h-full focus:outline-none" />
        <div className="flex gap-2">
        <button className="dark:bg-purple-600 h-10 w-10 flex justify-center items-center rounded-lg">
          <MdAttachFile size={20}/>
        </button>
        <button onClick={sendMessage} className="dark:bg-green-600 h-10 w-10 flex justify-center items-center rounded-lg">
          <MdSend size={20}/>
        </button>
        </div>
